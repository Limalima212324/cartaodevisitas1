...
// Botão do Portfólio
const abrirPortfolio = document.getElementById("abrir-portfolio"); // corrigido: id igual ao HTML

abrirPortfolio.addEventListener("click", function (event) {
    event.preventDefault(); // impede o comportamento padrão do botão

    // Abre uma nova janela para o portfólio
    const novaJanela = window.open("", "Portfólio", "width=800,height=600");
    ...
    novaJanela.document.write(` 
        ...
        <body>
            ...
            <div class="galeria">
                <img src="certificados/rihappy.jpg" alt="Imagem 1">
                <p><b> Ri Happy - Front-end do Zero</b></p> <!-- Descrição da imagem -->
                <b>
